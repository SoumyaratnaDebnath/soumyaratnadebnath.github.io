(function () {
  ...
  const actionLinks = [
    { label: "Email", href: "mailto:soumyara004@e.ntu.edu.sg", icon: "bi-envelope", iconOnly: true, className: "site-action-icon" },
    { label: "Resume", href: "documents/Resume-Soumyaratna.pdf", className: "site-button" }
  ];
  ...
  function renderFooter() {
    ...
    footer.innerHTML =
      ...
      "<span>Static HTML, CSS, and JavaScript site. No Quarto runtime required.</span>" +
      '<span><a href="' + pathFromRoot(root, "documents/Resume-Soumyaratna.pdf") + '">Resume</a> · <a href="' + pathFromRoot(root, "documents/Research-Portfolio.pdf") + '">Research Portfolio</a></span>' +
      "</div>";
  ...
  function formatOwnAuthorName(text) {
    const ownName = "Soumyaratna Debnath";
